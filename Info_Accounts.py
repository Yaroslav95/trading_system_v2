...
def GetAccount(qpProvider, ClientCode='', FirmId='SPBFUT', TradeAccountId='SPBFUT00PST', LimitKind=0, CurrencyCode='SUR'):
...
def get_info():
    ...
    GetAccount(qpProvider, '10NY8F', 'TQBR', 'L01-00000F00', 0, CurrencyCode='RUB')
    
    #(ClientCode='', FirmId='SPBFUT', TradeAccountId='SPBFUT00PST', LimitKind=0, CurrencyCode='SUR')
